                ...
                var pokemonOwners = new List<PokemonOwners>()
                {
                    new PokemonOwners()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                ...
                                new Review { Title="Pikachu", Text = "Pickachu is the best a killing water",
                    ...
                    new PokemonOwners()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                ...
                                Reviewer = new Reviewer(){ FirstName = "Teddy", LastName = "Smith" } },
                                new Review { Title= "Squirtle",Text = "Squirtle is the best at killing rocks",
                                Reviewer = new Reviewer(){ FirstName = "Taylor", LastName = "Jones" } },
                    ...
                    new PokemonOwners()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                new Review { Title="Veasaur",Text = "Venasuar is the best pokemon, because it is leaf",
                                Reviewer = new Reviewer(){ FirstName = "Teddy", LastName = "Smith" } },
                                new Review { Title="Veasaur",Text = "Venasuar is the best a killing electric",
                                Reviewer = new Reviewer(){ FirstName = "Taylor", LastName = "Jones" } },
